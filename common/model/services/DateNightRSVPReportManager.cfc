<cfcomponent accessors="true">
	...
	<cffunction name="init" access="public" returntype="DateNightRSVPReportManager">
	...
	<cffunction name="loadTransactions" access="public" returntype="any">
		...
		<cfquery name="qPending">
			...
			left outer join tr_productselected_datenightrsvp as it on ps.productSelectedID = it.productSelectedID
			where ps.productClassParam = <cfqueryparam cfsqltype="cf_sql_varchar" value="DateNightRSVP" />
	...
	<cffunction name="exportToExcel" access="public" returntype="void">
		...
		<cfscript>
			...
			filetowrite = GetDirectoryFromPath(GetCurrentTemplatePath()) & "../../../includes/assets/spreadsheets/DateNightRSVP-" & arguments.evtdate & ".xls";
			filetoopen = "includes/assets/spreadsheets/DateNightRSVP-" & arguments.evtdate & ".xls";
			...
			spreadsheetAddRow(spreadsheet,"TRANSACTIONID,CONFIRMATIONNUM,TRANSACTIONDATE,TRANSACTIONSTATUS,FIRSTNAME,LASTNAME,EMAIL,PRIPHONE,AMOUNT,PRODUCTNAME,EVENTSTART,NUMBEROFCHILDRENOVER5,NUMBEROFCHILDRENUNDER5");
