<cfcomponent extends="EntityDAO">
	...
	<cffunction name="init" access="public" returntype="ProductSelectedDAO">
		<cfreturn this />
	</cffunction>
	...
	<cfscript>
		...
		public any function populate(required obj) {
			...
			ent.setProductName(fc.productName);
			ent.setProductParam(fc.productParam);
			if (StructKeyExists(form, "comments")) ent.setComments(fc.comments);
