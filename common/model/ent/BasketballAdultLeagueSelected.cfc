component persistent="true" extends="ProductSelected" table="tr_productselected_basketballadultleague" joincolumn="productSelectedID" datasource="devcpctproducts" 
{
	/**
	* @display League Name
	* @required true
