component extends="org.corfield.framework" {
	...
	*/
	...
	variables.framework.routes = [
		{"$GET/public:displayform/:id/:id/$" 	= "/public:displayform/start/prodtype/:id/prod/:id" },
		{"$GET/public:contact/:id/$" 			= "/public:displayform/handleForm/prodtype/contactform/prod/:id" }
	];
