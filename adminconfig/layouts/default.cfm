...
<html lang="en">
	<head>
		...
		<title>Admin Config - <cfoutput>#rc.title#</cfoutput></title>
		...
		<link rel="stylesheet" href="/productmodule/includes/assets/css/adminconfig.css" />
	</head>
	<body>
	<cfoutput>
		<!-- top nav - corp nav -->
		...
		<div class="venueHeader" style="">	
			<div class="container">
				...
				<h2 style="margin:0px;padding:0px;">Product Module</h2>	
			</div>
		</div>
		<!-- end venue header -->
