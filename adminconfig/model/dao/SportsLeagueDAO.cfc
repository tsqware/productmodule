<cfcomponent extends="EntityDAO">
	...
	<cffunction name="init" access="public" returntype="SportsLeagueDAO">
		<cfreturn this />
	</cffunction>
	...
	<cfscript>
		...
		public any function populate(required obj, rc) {
			//WriteDump(var=rc, label="rc pop");
			obj.setLeagueName(rc.leagueName);
			obj.setLeagueParam(rc.leagueParam);
