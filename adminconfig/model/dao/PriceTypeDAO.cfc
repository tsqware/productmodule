<cfcomponent extends="EntityDAO">
	...
	<cffunction name="init" access="public" returntype="PriceTypeDAO">
		<cfreturn this />
	</cffunction>
	...
	<cfscript>
		...
		public any function populate(required obj, rc) {
			obj.setPriceTypeName(rc.priceTypeName);
			obj.setPriceTypeParam(rc.priceTypeParam);
			obj.setPriceTypeClassName(rc.priceTypeClassName);				
			return obj;
		}
