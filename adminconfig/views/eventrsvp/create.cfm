...
<form action="#buildURL(action='adminconfig:eventrsvp.doCreate', querystring='prodtype=#rc.prodtype#')#" method="post">
	<div class="row">
		<div class="col-md-6">
					...
					<fieldset>
						...
						<cfelse>
							...
							<cfloop array="#rc.prices#" index="priceItm">
								<input name="priceID" type="checkbox" value="#priceItm.getPriceID()#" />
									#priceItm.getPriceName()# - edit<br />
							</cfloop>
							</div>
						</cfif>
						<div><p>You will be able to add new prices for this product once the product is saved.</p></div>		
					</fieldset>
				</div>
			</div>
		</div>
