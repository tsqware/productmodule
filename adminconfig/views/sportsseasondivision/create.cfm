...
<cfif StructKeyExists(rc, "seasonName")>
	<h3 style="margin:0px; margin-bottom:20px;">#rc.seasonName#</h3>
</cfif>
...
<form action="#buildURL(action='adminconfig:sportsseasondivision.doCreate', querystring='sea=#rc.sea#')#" method="post">
	<div class="row">
		<div class="col-xs-6">
