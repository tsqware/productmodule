...
<form action="#buildURL(action='adminconfig:contactform.doCreate', querystring='prodtype=#rc.prodtype#')#" method="post">
	<div class="row">
		<div class="col-md-6">
			...
			<div class="panel panel-default">
				<div class="panel-body">		
					<fieldset>
						...
						<!--- 
							This is a new product, so it will not have a configuration.
							Prompt to create a form config, just for this product.
						 --->
						
						<cfif rc.hasFormConfig>							
							#rc.selectedFormConfig.getFormName()# - show<br />
						<cfelse>
