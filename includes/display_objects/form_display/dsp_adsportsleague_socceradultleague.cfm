<cfset pluginConfig.addToHTMLFootQueue("includes/assets/htmlhead/jquery.validate.cfm")><cfset pluginConfig.addToHTMLFootQueue("includes/assets/htmlfoot/jsfoot_socceradult.cfm")>
...
<!---
<cfset svc = CreateObject("component", "#$.siteConfig('pluginDir')#/plugins/MuraFW1/common.model.services.SoccerAdultLeagueService").init()>
...
##adsportsleague_socceradult label.error {
	display: block;
	width: auto;
	padding:0px;
	font-weight:normal;
...
##adsportsleague_socceradult div.error {
	margin:0px 0px 15px;
	display:none;
	padding:15px;
}
##adsportsleague_socceradult div.error li {
	list-style:disc;
	padding: 0px;
	margin:0px;
}
##adsportsleague_socceradult div.error ul {
	list-style:disc;
	padding: 0px;
...
<cfelse>
	...
	<form id="adsportsleague_socceradult" class="form-horizontal" method="post"
		action="#application.configBean.getContext()#/soccer/adult/league-registration-confirmation/">
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<input type="hidden" name="formSettingsFile" value="product-module/form-settings/soccer-adult-league-form-settings" />
