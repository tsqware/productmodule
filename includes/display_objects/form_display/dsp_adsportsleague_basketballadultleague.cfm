...
<cfset pluginConfig.addToHTMLFootQueue("includes/assets/htmlfoot/jsfoot_basketballadult.cfm")>
...
<cfset svc = CreateObject("component", "#$.siteConfig('pluginDir')#/plugins/MuraFW1/common.model.services.BasketballAdultLeagueService").init()>
...
##adsportsleague_basketballadult label.error {
...
##adsportsleague_basketballadult div.error {
...
##adsportsleague_basketballadult div.error li {
...
##adsportsleague_basketballadult div.error ul {
...
<cfelse>
	...
	<form id="adsportsleague_basketballadult" class="form-horizontal" method="post"

		action="#application.configBean.getContext()#/basketball/adult/league-registration-confirmation/">
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<input type="hidden" name="formSettingsFile" value="product-module/form-settings/basketball-adult-league-form-settings" />
