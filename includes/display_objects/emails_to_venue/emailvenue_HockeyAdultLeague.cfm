...
<cfoutput>
    ...
    <tr>
      <td><table width="620" border="0" cellpadding="0" cellspacing="1" style="margin: 0px auto; -moz-box-shadow: 0 2px 3px rgba(0,0,0,0.6); -webkit-box-shadow: 0 2px 3px rgba(0,0,0,0.6); border-collapse: separate; border-spacing: 1px; background-color: ##898989;">
        <tr>
          <td><p style="font-size: 18px; font-family: Helvetica, Arial, sans-serif; text-transform: uppercase; font-weight: bold; text-align: center; color: ##FFF; background-color: ##00997C; margin: 0px; padding: 8px 10px;" align="center"><strong>REGISTRATION SUMMARY</strong></p></td>
        </tr>
        <tr>
        	<td>
