...
$(document).ready(function() {
	...
	$("#adsportsleague_basketballadult").validate({

		errorContainer: $("#adsportsleague_basketballadult div.error"),

		errorLabelContainer: $("#adsportsleague_basketballadult div.error ul"),
	...
	$( "input[name='pricetype']" ).click(function() {
			...
			$.ajax({
				...
				url: "/plugins/ProductModule/common/model/services/BasketballAdultLeagueService.cfc",
