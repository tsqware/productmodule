...
$(document).ready(function() {
	...
	$('#calendar').fullCalendar({
		...
		eventSources: [
			{
				url: '/cpsite/adm/fh/productmodule/index.cfm?action=public:dropinprogramscheduleitem.listEvents&prod=rock-n-roll&reload=true', 
				textColor: '#333', 
				color: '#e4e4e4'
			},
			{
				url: '/cpsite/adm/fh/productmodule/index.cfm?action=public:dropinprogramscheduleitem.listAlerts&prod=rock-n-roll&reload=true', 
