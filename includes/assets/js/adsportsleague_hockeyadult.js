...
$(document).ready(function() {
	...
	$("#adsportsleague_hockeyadult").validate({

		errorContainer: $("#adsportsleague_hockeyadult div.error"),

		errorLabelContainer: $("#adsportsleague_hockeyadult div.error ul"),
	...
	$( "input[name='pricetype']" ).click(function() {
			...
			$.ajax({
				...
				url: "/plugins/ProductModule/common/model/services/HockeyAdultLeagueService.cfc",
